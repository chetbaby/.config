...
nmap <leader>bb <C-^> 
nmap <leader><leader>a mA
nmap <leader><leader>z 'A
nmap <leader><leader>s mS
nmap <leader><leader>x 'S
nmap <leader><leader>d mD
nmap <leader><leader>c 'D
nmap <leader><leader>f mF
nmap <leader><leader>v 'F
